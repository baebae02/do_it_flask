...
#for i in depts:
    #print(depts[i])
    #dept_temp = Major(code=depts[i]['code'], dept_nm=depts[i]['dept_nm'], up_nm=depts[i]['up_nm'], up_code=depts[i]['up_dept'], colg=depts[i]['colg'])
    #db.session.add(dept_temp)
    #print(dept_temp)
    
#db.session.commit()

#aa = Major(code='11', dept_nm='111', up_nm='1111', up_code='11', colg='11')
#db.session.add(aa)
#db.session.commit()
